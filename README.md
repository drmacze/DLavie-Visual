...
> **Status sebenarnya:** proyek ini **bukan port Derivative dan bukan shader
> programmable**. Isinya adalah resource pack visual ringan yang dibuat dari nol.
> Jangan mengunduh proyek ini dengan harapan mendapatkan shader Derivative di
> Bedrock. Lihat [cakupan teknis](docs/COMPATIBILITY.md) sebelum build.
...
Tidak ada file `.fsh`, `.vsh`, GLSL, Iris, atau OptiFine dalam paket ini. Menambahkan
file-file tersebut hanya agar proyek terlihat seperti shader tidak akan membuat
RenderDragon iOS menjalankannya. Daftar tepat antara fitur yang tersedia dan yang
tidak tersedia dicatat di [docs/COMPATIBILITY.md](docs/COMPATIBILITY.md).
